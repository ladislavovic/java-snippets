...
import cz.kul.snippets.spring._10_overriding.componentScanModule1.RootConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule10.RootInner2ConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule2.ParentConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule3.Importee1ConfigByComponentSccan2;
import cz.kul.snippets.spring._10_overriding.componentScanModule4.Importee2ConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule5.Importee1ConfigByComponentSccan1;
import cz.kul.snippets.spring._10_overriding.componentScanModule6.RootInner1ConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule7.ParentInnerConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule8.Importee1InnerConfigByComponentScan;
import cz.kul.snippets.spring._10_overriding.componentScanModule9.ParentOfRootInner1ConfigByComponentScan;
...
public class TestOverriding {
    ...
    @Configuration
    @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule3")
    public static class Importee1 {
        ...
        @Configuration
        @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule8")
    ...
    @Configuration
    @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule4")
    ...
    @Configuration
    @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule2")
    public static class Parent {
        ...
        @Configuration
        @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule7")
    ...
    @Configuration
    @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule9")
    ...
    @Configuration
    @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule1")
    @Import({
            Importee1.class,
            Importee2.class
    })
    public static class Root extends Parent {
        ...
        @Configuration
        @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule6")
        ...
        @Configuration
        @ComponentScan("cz.kul.snippets.spring._10_overriding.componentScanModule10")
