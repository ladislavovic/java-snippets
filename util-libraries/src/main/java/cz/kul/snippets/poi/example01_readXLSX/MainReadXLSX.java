package cz.kul.snippets.poi.example01_readXLSX;
...
public class MainReadXLSX {
    ...
    private static void read_XLSX_file() throws IOException {
        ...
        //
        try (InputStream input = MainReadXLSX.class.getClassLoader().getResourceAsStream("numbers.xlsx");
